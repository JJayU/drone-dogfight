...
# 15 nowych celów z nowymi pozycjami i odwrotnymi yaw (pierwotny_yaw + π)
        self.defined_targets = [
            [2.00, 1.00, 1.50, 0.0 + math.pi],      # 3.142
            [-0.12, 1.48, 1.00, 0.5 + math.pi],     # 3.642
            [2.54, -0.66, 2.00, 1.0 + math.pi],     # 4.142 → -2.142
            [-1.93, -0.50, 1.80, 1.5 + math.pi],    # 4.642 → -1.642
            [0.54, 1.66, 1.00, -1.0 + math.pi],     # 2.142
            [2.38, -2.98, 2.20, -0.5 + math.pi],    # 2.642
            [-0.80, 2.72, 1.40, 0.8 + math.pi],     # 3.942 → -2.342
            [3.48, 0.20, 1.90, 0.2 + math.pi],      # 3.342 → -2.942
            [-1.80, -0.72, 2.10, -0.8 + math.pi],   # 2.342
            [0.36, -3.43, 1.30, -1.2 + math.pi],
        ]
